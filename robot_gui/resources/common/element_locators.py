...
GRAPH_NODE_POWEROFF_TABLE_CLASS = '//span[@class="cortx-menu-icon cortx-power-off-node-icon-online"]'
GRAPH_NODE_POWER_STORAGEOFF_TABLE_CLASS = '//span[@class="cortx-menu-icon cortx-power-storage-off-node-icon-online"]'
