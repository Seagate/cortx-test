...
CHECK_IN_NEW_ALERTS
    ...
    [Tags]  PYTEST  CHECK_IN_NEW_ALERTS
    Check if alert exists in New alerts tab  ${description}

ACKNOWLEDGE_NEW_ALERTS
    [Documentation]  CSM GUI: acknowledge alert from new alert table
    [Tags]  PYTEST  ACKNOWLEDGE_NEW_ALERTS
    Acknowledge if New alerts exist  ${description}

ACKNOWLEDGE_ACTIVE_ALERT
    [Documentation]  CSM GUI: acknowledge alert from active alert table
    [Tags]  PYTEST  ACKNOWLEDGE_ACTIVE_ALERT
...
CHECK_IN_NEW_ALERTS_AND_FAIL
    ...
    [Tags]  PYTEST  CHECK_IN_NEW_ALERTS_AND_FAIL
...
CHECK_IN_ACTIVE_ALERTS
    ...
    [Tags]  PYTEST  CHECK_IN_ACTIVE_ALERTS
...
CHECK_IN_ACTIVE_ALERTS_AND_FAIL
    ...
    [Tags]  PYTEST  CHECK_IN_ACTIVE_ALERTS_AND_FAIL
...
CHECK_IN_ALERT_HISTORY
    ...
    [Tags]  PYTEST  CHECK_IN_ALERT_HISTORY
...
CHECK_IN_ALERTS_HISTORY_AND_FAIL
    ...
    [Tags]  PYTEST  CHECK_IN_ALERTS_HISTORY_AND_FAIL
