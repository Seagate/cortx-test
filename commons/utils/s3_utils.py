...
def get_aligned_parts(file_path, total_parts=1, chunk_size=5242880, random=False) -> dict:
    """
    Create the upload parts dict with aligned part size(limitation: not supported not than 10G).
...
def get_unaligned_parts(file_path, total_parts=1, chunk_size=5242880, random=False) -> dict:
    """
    Create the upload parts dict with unaligned part size(limitation: not supported not than 10G).
