...
AWSCLI_REMOVE_OBJECTS = "aws s3 rm s3://{0}/{1}"
AWSCLI_RECURSIVE_FLAG = "--recursive"
AWSCLI_EXCLUDE_FLAG = "--exclude '{}'"
AWSCLI_INCLUDE_FLAG = "--include '{}'"
AWSCLI_CREATE_MULTIPART_UPLOAD = "aws s3api create-multipart-upload --bucket {0} --key {1}"
AWSCLI_LIST_MULTIPART_UPLOADS = "aws s3api list-multipart-uploads --bucket {0}"
AWSCLI_UPLOAD_PARTS = "aws s3api upload-part --bucket {0} --key {1} --part-number {2} " \
                      "--body {3} --upload-id {4}"
AWSCLI_LIST_PARTS = "aws s3api list-parts --bucket {0} --key {1} --upload-id {2}"
AWSCLI_COMPLETE_MULTIPART = "aws s3api complete-multipart-upload --multipart-upload file://{0} " \
                            "--bucket {1} --key {2} --upload-id {3}"
AWSCLI_DOWNLOAD_OBJECT = "aws s3 cp s3://{0}/{1} {2}"
