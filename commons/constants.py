...
RGW_ERR_LONG_OBJ_NAME = "An error occurred (InvalidObjectName) when calling the PutObject operation: Unknown"
CORTX_ERR_LONG_OBJ_NAME = "An error occurred (KeyTooLongError) when calling the PutObject operation: Your key is too long."
RGW_ERR_WRONG_JSON = "An error occurred (InvalidPart) when calling the CompleteMultipartUpload "
"operation: Unknown"
CORTX_ERR_WRONG_JSON = "An error occurred (InvalidPart) when calling the CompleteMultipartUpload operation: One or more of the specified parts could not be found. The part might not have been uploaded, or the specified entity tag might not have matched the part's entity tag."
