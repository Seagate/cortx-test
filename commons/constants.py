...
# MOTR_CONTAINER_PREFIX = "cortx-data"  # cortx-motr-io-001
MOTR_CONTAINER_PREFIX = "cortx-motr-io-001"  # Todo: Remove this cortx-motr-io-001
...
MOTR_DI_ERR_INJ_LOCAL_PATH = "scripts/server_scripts/error_injection.py"
