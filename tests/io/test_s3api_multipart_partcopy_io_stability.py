    ...
    async def execute_multipart_partcopy_workload(self):
        ...
        while True:
            ...
            try:
                ...
                assert number_of_parts > 10000, f"Number of parts should be less than 10k"
                ...
                logger.info("Create multipart upload: s3://{}/{}", mpart_bucket, mpart_object)
