...
class SSPLTest:
    ...
    @pytest.mark.ras
    @pytest.mark.tags("TEST-1648", "pacemaker_sspl", "sw_alert")
    def test_1648(self):
        """
    ...
    @pytest.skip
    @pytest.mark.ras
    @pytest.mark.tags("TEST-1783", "pacemaker_sspl", "sw_alert")
    def test_1783(self):
        """
    ...
    @pytest.mark.ras
    @pytest.mark.tags("TEST-1645", "pacemaker_sspl", "sw_alert")
    def test_1645(self):
        """
