...
"""
 HA: Publish the pod failure event in message bus to Hare - Delete pod
"""
import logging
import pytest
import json
...
class TestHA:
    ...
    def test_ha(self):
        """Verify Publish the pod failure event in message bus to Hare - Delete pod """
