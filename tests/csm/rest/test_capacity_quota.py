...
class TestCapacityQuota():
    ...
    def test_40600(self):
        ...
        assert user_quota['enabled'] == True, "Status check failed"
    ...
    def test_40601(self):
        ...
        assert user_quota['enabled'] == False, "Status check failed"
        assert user_quota['max_size'] == max_size, "Max size field not matched"
        assert user_quota['max_objects'] == max_objects, "Objects field not matched"
        self.log.info("##### Test ended -  %s #####", test_case_name)
    ...
    def test_40602(self):
        ...
        assert user_quota['user_quota']['enabled'] == True, "Status check failed"
    ...
    def test_40604(self):
        ...
        self.log.info("Creating IAM user payload.")
        user_id, display_name, tenant = self.csm_obj.get_iam_user_payload("tenant")
