...
class TestBucketPolicy:
    ...
    def test_254(self):
        ...
        self.create_bucket_validate("bktpolicy-254")
        self.log.info(
    ...
    def test_722(self):
        ...
        bkt_cnf_722["bucket_policy"]["Statement"][0]["Principal"]["AWS"] = \
            bkt_cnf_722["bucket_policy"]["Statement"][0]["Principal"]["AWS"].format(account_id,
                                                                                    user_name)
    ...
    def test_1187(self):
        ...
        bkt_cnf_1187["bucket_policy"]["Statement"][0]["Principal"]["AWS"][0] = \
            bkt_cnf_1187["bucket_policy"]["Statement"][0]["Principal"]["AWS"][0].format(account_id,
                                                                                        user_name)
        bkt_cnf_1187["bucket_policy"]["Statement"][1]["Principal"]["AWS"][0] = \
            bkt_cnf_1187["bucket_policy"]["Statement"][1]["Principal"]["AWS"][0].format(account_id,
                                                                                        user_name)
...
_date
    ...
    def test_5449(self):
        ...
        acc_details = IAM_OBJ.create_multiple_accounts(
            test_5449_cfg["acc_count"], self.acc_name_prefix)
        account1_id = acc_details[1][0][1]["Account_Id"]
        S3_OBJ1 = s3_test_lib.S3TestLib(
            access_key=acc_details[1][0][1]["access_key"],
            secret_key=acc_details[1][0][1]["secret_key"])
    ...
    def test_5471(self):
        ...
        acc_details = IAM_OBJ.create_multiple_accounts(
            test_5471_cfg["acc_count"], self.acc_name_prefix)
        account1_id = acc_details[1][0][1]["Account_Id"]
        S3_OBJ1 = s3_test_lib.S3TestLib(
            access_key=acc_details[1][0][1]["access_key"],
            secret_key=acc_details[1][0][1]["secret_key"])
    ...
    def test_5473(self):
        ...
        acc_details = IAM_OBJ.create_multiple_accounts(
            test_5473_cfg["acc_count"], self.acc_name_prefix)
        account1_id = acc_details[1][0][1]["Account_Id"]
        S3_OBJ1 = s3_test_lib.S3TestLib(
            access_key=acc_details[1][0][1]["access_key"],
            secret_key=acc_details[1][0][1]["secret_key"])
    ...
    def test_5481(self):
        ...
        acc_details = IAM_OBJ.create_multiple_accounts(
            test_5481_cfg["acc_count"], self.acc_name_prefix)
        account1_id = acc_details[1][0][1]["Account_Id"]
        S3_OBJ1 = s3_test_lib.S3TestLib(
            access_key=acc_details[1][0][1]["access_key"],
            secret_key=acc_details[1][0][1]["secret_key"])
    ...
    def test_6550(self):
        ...
        acc_details = IAM_OBJ.create_multiple_accounts(
            test_6550_cfg["acc_count"], self.acc_name_prefix)
        account1_id = acc_details[1][0][1]["Account_Id"]
    ...
    def test_6693(self):
        ...
        account_name = "{0}{1}".format(self.account_name, str(
            time.time()))
        email_id = "{0}{1}".format(account_name, self.email_id)
        acc_details = self.create_s3iamcli_acc(account_name, email_id)
    ...
    def test_5212(self):
        ...
        user_name = "{0}{1}".format(self.user_name, str(
            time.time()))
        acc_details = IAM_OBJ.create_multiple_accounts(
            test_5212_cfg["acc_count"], self.acc_name_prefix)
        ...
        assert resp[0], resp[1]
        assert_utils.assert_equals(resp[1]["Policy"], bkt_policy_json_1, resp[1])
        self.log.info(
            "Step 4: Retrieved policy of a bucket %s", bucket_name)
    ...
    def test_6771(self):
        ...
        account_name = "{0}{1}".format(
            self.account_name, str(timestamp))
        email_id = "{0}{1}".format(account_name, self.email_id)
        self.create_bucket_put_objects(
            bucket_name,
    ...
    def test_7053(self):
        ...
        acc_details = IAM_OBJ.create_multiple_accounts(
            test_7053_cfg["acc_count"], self.acc_name_prefix)
        account1_id = acc_details[1][0][1]["Account_Id"]
        S3_OBJ1 = s3_acl_test_lib.S3AclTestLib(
            access_key=acc_details[1][0][1]["access_key"],
            secret_key=acc_details[1][0][1]["secret_key"])
    ...
    def test_6554(self):
        ...
        acc_details = IAM_OBJ.create_multiple_accounts(
            test_6554_cfg["acc_count"], self.acc_name_prefix)
        ...
        try:
            ...
            assert err_message in error.message, error.message
        try:
            S3_OBJ1.put_object_with_acl(bucket_name, "{}{}".format(object_lst[0], str(
    ...
    def test_6555(self):
        ...
        acc_details = IAM_OBJ.create_multiple_accounts(
            test_6555_cfg["acc_count"], self.acc_name_prefix)
        account2_id = acc_details[1][0][1]["Account_Id"]
        account2_cid = acc_details[1][0][1]["canonical_id"]
        account3_cid = acc_details[1][1][1]["canonical_id"]
        account4_cid = acc_details[1][2][1]["canonical_id"]
    ...
    def test_1295(self):
        ...
        try:
            resp = S3_OBJ.list_objects_with_prefix(
                bucket_name, prefix=self.obj_name_prefix)
            assert resp[0], resp[1]
            self.log.info(
    ...
    def test_4598(self):
        ...
        self.log.info("Step 1: Creating a bucket and uploading objects to it")
        self.create_bucket_put_objects(
            bucket_name, obj_count, self.obj_name_prefix)
        self.log.info("Step 1: Created a bucket and uploaded objects to it")
    ...
    def test_7015(self):
        ...
        assert resp[0], resp[1]
        assert_utils.assert_equals(len(resp[1]), test_cfg["total_parts"], resp[1])
        parts = res[1]
    ...
    def test_7849(self):
        ...
        assert resp[0], resp[1]
        assert_utils.assert_equals(resp[1]["BucketName"], bucket_name, resp)
        self.log.info(
