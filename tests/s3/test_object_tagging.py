...
class TestObjectTagging:
    ...
    def test_verify_putobj_tagging_2457(self):
        ...
        self.create_put_set_object_tag(
            ...
            self.file_path,
            mb_count=OBJ_TAG_CONFIG["object_tagging"]["mb_count"],
            key=OBJ_TAG_CONFIG["test_9413"]["key"],
            value=OBJ_TAG_CONFIG["test_9413"]["value"])
        self.log.info(
    ...
    def test_getobj_tagging_2458(self):
        ...
        self.create_put_set_object_tag(
            ...
            self.file_path,
            mb_count=OBJ_TAG_CONFIG["object_tagging"]["mb_count"],
            key=OBJ_TAG_CONFIG["test_9414"]["key"],
            value=OBJ_TAG_CONFIG["test_9414"]["value"])
        self.log.info(
            "Created a bucket, uploaded an object and tag is set for object")
        self.log.info("Retrieving tag of an object %s",
                         OBJ_TAG_CONFIG["test_9414"]["object_name"])
    ...
    def test_delobj_tagging_2459(self):
        ...
        self.create_put_set_object_tag(
            ...
            self.file_path,
            mb_count=OBJ_TAG_CONFIG["object_tagging"]["mb_count"],
            key=OBJ_TAG_CONFIG["test_9415"]["key"],
            value=OBJ_TAG_CONFIG["test_9415"]["value"])
        self.log.info(
            "Created a bucket, uploaded an object and tag is set for object")
        self.log.info("Retrieving tag of an object %s",
                         OBJ_TAG_CONFIG["test_9415"]["object_name"])
    ...
    def test_add_maximum_tags_existing_object_2463(self):
        ...
        self.create_put_set_object_tag(
            ...
            self.file_path,
            mb_count=OBJ_TAG_CONFIG["object_tagging"]["mb_count"],
            key=OBJ_TAG_CONFIG["test_9419"]["key"],
            value=OBJ_TAG_CONFIG["test_9419"]["value"],
            tag_count=OBJ_TAG_CONFIG["test_9419"]["tag_count"])
        self.log.info(
    ...
    def test_key_128unicodechars_2467(self):
        ...
        self.create_put_set_object_tag(
            ...
            self.file_path,
            mb_count=OBJ_TAG_CONFIG["object_tagging"]["mb_count"],
            key=OBJ_TAG_CONFIG["test_9423"]["key"],
            value=OBJ_TAG_CONFIG["test_9423"]["value"])
        self.log.info(
            "Created a bucket, uploaded an object and tag is set for object")
        self.log.info("Retrieving tag of an object %s",
                         OBJ_TAG_CONFIG["test_9423"]["object_name"])
    ...
    def test_tagvalue256chars_2469(self):
        ...
        self.create_put_set_object_tag(
            ...
            self.file_path,
            mb_count=OBJ_TAG_CONFIG["object_tagging"]["mb_count"],
            key=OBJ_TAG_CONFIG["test_9425"]["key"],
            value=OBJ_TAG_CONFIG["test_9425"]["value"])
        self.log.info(
            "Created a bucket, uploaded an object and tag is set for object")
        self.log.info("Retrieving tag of an object %s",
                         OBJ_TAG_CONFIG["test_9425"]["object_name"])
    ...
    def test_tagkeys_labels_2471(self):
        ...
        self.create_put_set_object_tag(
            ...
            self.file_path,
            mb_count=OBJ_TAG_CONFIG["object_tagging"]["mb_count"],
            key=OBJ_TAG_CONFIG["test_9427"]["key1"],
            value=OBJ_TAG_CONFIG["test_9427"]["value"])
        self.log.info(
            "Created a bucket, uploaded an object and tag is set for object")
        self.log.info("Retrieving tag of an object %s",
                         OBJ_TAG_CONFIG["test_9427"]["object_name"])
    ...
    def test_case_sensitive_labels_2472(self):
        ...
        self.create_put_set_object_tag(
            ...
            self.file_path,
            mb_count=OBJ_TAG_CONFIG["object_tagging"]["mb_count"],
            key=OBJ_TAG_CONFIG["test_9428"]["key"],
            value=OBJ_TAG_CONFIG["test_9428"]["value1"])
        self.log.info(
            "Created a bucket, uploaded an object and tag is set for object")
        self.log.info("Retrieving tag of an object %s",
                         OBJ_TAG_CONFIG["test_9428"]["object_name"])
    ...
    def test_valid_specialchars_2473(self):
        ...
        self.create_put_set_object_tag(
            ...
            self.file_path,
            mb_count=OBJ_TAG_CONFIG["object_tagging"]["mb_count"],
            key=OBJ_TAG_CONFIG["test_9429"]["key"],
            value=OBJ_TAG_CONFIG["test_9429"]["value"])
        self.log.info(
            "Created a bucket, uploaded an object and tag is set for object")
        self.log.info("Retrieving tag of an object %s",
                         OBJ_TAG_CONFIG["test_9429"]["object_name"])
