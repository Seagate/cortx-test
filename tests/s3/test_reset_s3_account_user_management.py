...
class TestResetAccountUserManagement:
    ...
    def test_22793(self):
        ...
        assert_utils.assert_true(resp[0], resp[1])
        self.log.info("Step 7: cleanup resources.")
        resp = s3_test_obj1.delete_bucket(self.bucket_name1, force=True)
        assert_utils.assert_true(resp[0], resp[1])
        resp = s3_test_obj2.delete_bucket(self.bucket_name2, force=True)
        assert_utils.assert_true(resp[0], resp[1])
    ...
    def test_22794(self):
        ...
        resp = self.csm_obj.csm_user_create(csm_use, csm_use_mail, self.s3acc_passwd, role="monitor")
        assert_utils.assert_true(resp[0], resp[1])
