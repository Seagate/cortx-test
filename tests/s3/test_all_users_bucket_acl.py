...
all_users_conf = read_yaml("config/s3/test_all_users_bucket_acl.yaml")[1]
...
class TestAllUsers():
    ...
    def teardown_method(self):
        ...
        all_users_buckets = [
            bucket for bucket in bucket_list if all_users_conf["all_users"]["bkt_name_prefix"] in bucket]
        for bucket in all_users_buckets:
            ACL_OBJ.put_bucket_acl(
                bucket,
                grant_full_control=all_users_conf["all_users"]["group_uri"])
    ...
    def test_375(self):
        ...
        resp = ACL_OBJ.put_bucket_acl(
            all_users_conf["test_375"]["bucket_name"],
            grant_read=all_users_conf["all_users"]["group_uri"])
        assert_true(resp[0], resp[1])
        ...
        assert_equal(
            ...
            all_users_conf["test_375"]["permission"],
            resp[1])
    ...
    def test_376(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_376"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_377(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_377"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_378(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_378"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_379(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_379"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
    ...
    def test_380(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_380"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
    ...
    def test_381(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_381"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_382(self):
        ...
        resp = ACL_OBJ.put_bucket_acl(
            all_users_conf["test_382"]["bucket_name"],
            grant_write=all_users_conf["all_users"]["group_uri"])
        assert_true(resp[0], resp[1])
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_382"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_383(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_383"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
        ...
        resp = ACL_OBJ.put_bucket_acl(
            all_users_conf["test_383"]["bucket_name"],
            acl=all_users_conf["test_383"]["acl"])
        assert_true(resp[0], resp[1])
    ...
    def test_384(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_384"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_385(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_385"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
    ...
    def test_386(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_386"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
    ...
    def test_387(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_387"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_388(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_388"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_389(self):
        ...
        resp = ACL_OBJ.put_bucket_acl(
            all_users_conf["test_389"]["bucket_name"],
            grant_read_acp=all_users_conf["all_users"]["group_uri"])
        assert_true(resp[0], resp[1])
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_389"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
    ...
    def test_390(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_390"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_391(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_391"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_392(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_392"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_393(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_393"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_394(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_394"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_395(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_395"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_396(self):
        ...
        resp = ACL_OBJ.put_bucket_acl(
            all_users_conf["test_396"]["bucket_name"],
            grant_write_acp=all_users_conf["all_users"]["group_uri"])
        assert_true(resp[0], resp[1])
        self.log.info(
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_396"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_397(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_397"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_398(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_398"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_399(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_399"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_400(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_400"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_401(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_401"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_401"]["new_permission"],
            resp[1])
        self.log.info(
    ...
    def test_402(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_402"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_403(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_403"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
        ...
        assert_true(resp[0], resp[1])
        assert_in(
            all_users_conf["test_403"]["obj_name"], str(
                resp[1]), resp[1])
        self.log.info(
    ...
    def test_404(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_404"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
        ...
        resp = NO_AUTH_OBJ.object_list(
            all_users_conf["test_404"]["bucket_name"])
        assert_in(
            all_users_conf["test_404"]["new_obj_name"], str(
                resp[1]), resp[1])
        self.log.info(
    ...
    def test_405(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_405"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
    ...
    def test_406(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_406"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
            "Step 4: Reading object ACL through other unsigned account")
    ...
    def test_407(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_407"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
            "Step 4: Reading bucket ACL through other unsigned account")
    ...
    def test_408(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_408"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
            "Step 4: Updating bucket ACL through other unsigned account")
        resp = NO_AUTH_OBJ.put_bucket_acl(
            all_users_conf["test_408"]["bucket_name"],
            acl=all_users_conf["test_408"]["acl"])
        assert_true(resp[0], resp[1])
        resp = ACL_OBJ.get_bucket_acl(
            all_users_conf["test_408"]["bucket_name"])
        assert_equal(
    ...
    def test_409(self):
        ...
        assert_equal(
            resp[1][1][0]["Permission"],
            all_users_conf["test_409"]["permission"],
            resp[1])
        self.log.info("Step 3: Verified bucket permission is changed")
        self.log.info(
            "Step 4: Updating object ACL through other unsigned account")
