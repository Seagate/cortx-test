...
class TestAccountLoginProfile:
    ...
    def teardown_method(self):
        ...
        for acc_name in all_acc:
            IAM_OBJ.reset_access_key_and_delete_account(acc_name)
    ...
    def create_account_n_login_profile(
        ...
        acc_res = IAM_OBJ.create_account(acc_name, email,
                                                  ldap_user, ldap_pwd)
        ...
        login_res = IAM_OBJ.create_account_login_profile(
    ...
    def test_2805(self):
        ...
        list_account = IAM_OBJ.list_accounts(
        ...
        res = IAM_OBJ.create_account(self.account_name, self.email_id,
                                              self.ldap_user, self.ldap_pwd)
        ...
        LOGGER.info(
            ...
            self.account_name)
        res = IAM_OBJ.create_account_login_profile(
    ...
    def test_2829(self):
        ...
        LOGGER.info(
            ...
            self.account_name)
        res = IAM_OBJ.get_account_login_profile(
            self.account_name, access_key, secret_key)
        LOGGER.debug(res)
        assert_true(res[0], res[1])
        LOGGER.info(
    ...
    def test_2834(self):
        ...
        LOGGER.info(
            ...
            self.account_name)
        resp = IAM_OBJ.update_account_login_profile(
    ...
    def test_2892(self):
        ...
        LOGGER.info("Step 4: Creating user login profile for user %s",
                    user_name)
        res = IAM_OBJ.create_user_login_profile(
            user_name,
