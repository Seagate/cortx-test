...
class TestMultipartUpload:
    ...
    def test_multipart_upload_for_file_2061_2065_2066_2069(self):
        ...
        res = self.s3_mp_test_obj.complete_multipart_upload(
            ...
            mp_config["object_name"])
        assert_utils.assert_true(res[0], res[1])
        res = self.s3_test_obj.object_list(mp_config["bucket_name"])
    ...
    def test_multipart_upload_file_1gb_to_10gb_2062(self):
        ...
        self.log.info(
            ...
            mp_config["bucket_name"])
        res = self.s3_test_obj.create_bucket(mp_config["bucket_name"])
        assert_utils.assert_true(res[0], res[1])
    ...
    def test_list_multipart_upload_2068(self):
        ...
        res = self.s3_mp_test_obj.list_multipart_uploads(mp_config["bucket_name"])
    ...
    def test_abort_multipart_upload_from_client2_started_from_client1_2073(
        ...
        s3_mp_test_obj_client2 = S3MultipartTestLib(endpoint_url=S3_CFG["s3_url"])
