...
motr_obj = motr_test_lib.MotrTestLib()
workload_config = config_utils.read_yaml("config/motr/test_workload.yaml")
assert workload_config[0]
workload_config = workload_config[1]
...
class TestExecuteWorkload:
    ...
    def execute_test(self, tc_num):
        ...
        for run in range(runs):
            ...
            for index in range(len(batches)):
                cmd = motr_obj.get_command_str(batches[index])
                if cmd:
    ...
    def test_14882(self):
        ...
        :avocado: tags=execute_m0crate_workload_test
        """
    ...
    def test_14925(self):
        ...
        batches, runs = self.get_batches_runs('test_14925')
    ...
    def test_23198(self):
        ...
        :avocado: tags=execute_m0kv_test
        """
