# CORTX-TEST ARCHITECTURE OVERVIEW
## Introduction
...
*  Corbot: A program which sets up necessary environment and pre-requisites to run test automation pointing to a single target.
