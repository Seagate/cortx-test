...
"""This file contains S3 object range read operations test script for s3 stability."""
...
class TestObjectRangeReadOps(S3Object, S3Bucket):
    """S3 Object range read operations class for executing given s3 stability workload"""
