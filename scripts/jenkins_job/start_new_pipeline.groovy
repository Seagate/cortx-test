	...
	post {
		always {
			catchError(stageResult: 'FAILURE') {
				...
				emailext body: '${SCRIPT, template="REL_QA_SANITY_CUS_EMAIL_2.template"}', subject: '$PROJECT_NAME on Build # $CORTX_BUILD - $BUILD_STATUS!', to: 'nitesh.mahajan@seagate.com, dhananjay.dandapat@seagate.com, sonal.kalbende@seagate.com, balaji.ramachandran@seagate.com'
			}
		}
	}
}
