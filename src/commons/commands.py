...
K8S_TAINT_NODE = "kubectl taint node {} node-role.kubernetes.libs/master=:NoSchedule"
K8S_REMOVE_TAINT_NODE = "kubectl taint node {} node-role.kubernetes.libs/master=:NoSchedule-"
...
K8S_WORKER_NODES = "kubectl get nodes -l node-role.kubernetes.libs/worker=worker | awk '{print $1}'"
K8S_MASTER_NODE = "kubectl get nodes -l node-role.kubernetes.libs/master | awk '{print $1}'"
