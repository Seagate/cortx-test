...
class S3bench:
    ...
    def __init__(self, access: str, secret: str, endpoint: str, test_id: str, clients: int,
                 samples: int, size_low: int, size_high: int, seed: int, head: bool = True,
                 skip_read: bool = True, skip_write: bool = False, skip_cleanup: bool = False,
                 validate: bool = True, duration: timedelta = None, multipart: str = "0b") -> None:
        ...
        :param multipart: Multipart object size
        """
        random.seed(seed)
