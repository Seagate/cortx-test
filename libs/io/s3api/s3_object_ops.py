...
class S3Object(S3RestApi):
    ...
    def get_s3object_checksum(self, bucket_name: str, object_name: str, chunk_size: int, ranges: str = '') -> str:
        """
        ...
        """
        file_obj = self.s3_resource.Object(bucket_name, object_name, ranges).get()['Body']
