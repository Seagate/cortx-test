...
class S3Lib:
    ...
    def put_object(self,
        ...
        m_value = kwargs.get("m_value") if kwargs.get(
            "m_value", None) else None
...
class Tagging(S3Lib):
    ...
    def put_object_with_tagging(self,
        ...
        :return: response.
        """
        tag = kwargs.get("tag") if kwargs.get("tag", None) else None
        meta = kwargs.get("meta") if kwargs.get("meta", None) else None
        if meta:
