...
def get_hsbench_workload_headings(html, sessions, buckets, objects):
    return html.H5("Workload: {0} Sessions, {1} Buckets, {2} Objects".format(sessions, buckets, int(objects/buckets)))
...
def get_bucketops_everything(workload, branch, build, object_size, table_ID):
    ...
    bucket_ops = ['AvgLat','MinLat', 'MaxLat', 'Iops', 'Mbps', 'Ops', 'Seconds']
